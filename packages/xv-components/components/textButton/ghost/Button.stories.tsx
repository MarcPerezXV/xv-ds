...
import { GhostTextButton } from "./Button";
...
const meta: Meta<typeof GhostTextButton> = {
  title: "Components/TextButton/Ghost",
  component: GhostTextButton,
  tags: ["autodocs"],
...
export default meta;
type Story = StoryObj<typeof GhostTextButton>;
